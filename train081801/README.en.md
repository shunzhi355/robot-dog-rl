...
cd <exported_project>
python -m pip install -e source/stackforce_simready_081801_gym
python scripts/list_envs.py
python scripts/train.py --task stackforce_081801 --headless --num_envs 64 --max_iterations 100
```
...
```bash
python scripts/train.py --task stackforce_081801 --resume --load_run <run_dir_name> --checkpoint <checkpoint_number>
```

### Play A Trained Policy

```bash
python scripts/play.py --task stackforce_081801
```

To load a specific checkpoint:

```bash
python scripts/play.py --task stackforce_081801 --checkpoint_path logs/081801/<timestamp>/model_final.pt
```

Regenerate ONNX from a checkpoint:

```bash
python scripts/play.py --task stackforce_081801 --checkpoint_path logs/081801/<timestamp>/model_final.pt --export_onnx --num_steps 1
```
...
```text
source/stackforce_simready_081801_gym/stackforce_simready_081801_gym/tasks/081801/custom_rewards.py
```
...
```text
source/stackforce_simready_081801_gym/stackforce_simready_081801_gym/tasks/081801/081801_config.py
```
